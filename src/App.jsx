  ...
  return (
    <>
      ...
      <Carousel autoPlay={true} infiniteLoop={true} showArrows={false} showStatus={false} showThumbs={false}>
        <div className="main w-full   border-2 border-gray-200 border-solid flex flex-col sm:flex-row sm:h-96 ">
          <div className="imagecon w-full  sm:h-full sm:w-3/5 lg:w-2/5">
            <img src='http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631912/olympic_flag.jpg' alt="" className="w-full h-full" />
          </div>
        ...
        <div className="main w-full  border-2 border-gray-200 border-solid flex flex-col sm:flex-row sm:h-96 ">
          <div className="imagecon w-full sm:h-full sm:w-3/5 lg:w-2/5">
            <img src='http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631965/olympic_flag.jpg' alt="" className="w-full h-full" />
          </div>
          <div className="description px-7 py-5 flex flex-col sm:justify-center md:justify-start items-start sm:w-2/5 lg:w-3/5 xl:justify-center">
      ...
      <div className="lapitems w-full  grid justify-items-center grid-cols-1 gap-y-1 sm:gap-x-3 sm:grid-cols-2 xl:grid-cols-4 xl:justify-items-center xl:gap-x-0">
        <div className="itemcon w-11/12   ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631346/olympic_flag.jpg" alt="" className='w-full' />
          </div>
        ...
        <div className="itemcon w-11/12 ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631419/olympic_flag.jpg" alt="" className='w-full' />
          </div>
          <div className="lapdescription flex flex-col py-5 px-2">
        ...
        <div className="itemcon w-11/12 ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631492/olympic_flag.jpg" alt="" className='w-full' />
          </div>
          <div className="lapdescription flex flex-col py-5 px-2">
        ...
        <div className="itemcon w-11/12 ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631561/olympic_flag.jpg" alt="" className='w-full' />
          </div>
          <div className="lapdescription flex flex-col py-5 px-2">
      ...
      <div className="bigimage w-full flex justify-center mt-7 lg:h-96  xl:h-[35rem]">
        <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631597/olympic_flag.jpg" alt="" className=' w-11/12 rounded-sm lg:hidden' />
        <div className="largeimg w-11/12 hidden lg:block h-full lg:relative bg-[url('http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631597/olympic_flag.jpg')] bg-cover">
      ...
      <div className="lapitems w-full  grid justify-items-center grid-cols-1 gap-y-1 sm:gap-x-3 sm:grid-cols-2 xl:grid-cols-4 xl:justify-items-center xl:gap-x-0">
        <div className="itemcon w-11/12   ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631653/olympic_flag.jpg" alt="" className='w-full' />
          </div>
          <div className="lapdescription  flex flex-col py-5 px-2">
        ...
        <div className="itemcon w-11/12 ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631686/olympic_flag.jpg" alt="" className='w-full' />
          </div>
          <div className="lapdescription flex flex-col py-5 px-2">
        ...
        <div className="itemcon w-11/12 ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631725/olympic_flag.jpg" alt="" className='w-full' />
          </div>
          <div className="lapdescription flex flex-col py-5 px-2">
        ...
        <div className="itemcon w-11/12 ">
          <div className="imageconlap">
            <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631754/olympic_flag.jpg" alt="" className='w-full' />
          </div>
          <div className="lapdescription flex flex-col py-5 px-2">
      ...
      <div className="bigimage w-full flex justify-center mt-7 lg:h-96  xl:h-[35rem]">
        <img src="http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631798/olympic_flag.jpg" alt="" className=' w-11/12 rounded lg:hidden' />
        <div className="largeimg w-11/12  justify-start items-center hidden lg:flex h-full  bg-[url('http://res.cloudinary.com/dw4wbtjju/image/upload/v1697631798/olympic_flag.jpg')] bg-cover">
