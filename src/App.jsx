    ...
    <>
      ...
      <Carousel autoPlay={true} infiniteLoop={true} showArrows={false} showStatus={false} showThumbs={false}>
        <div className="main w-full   border-2 border-gray-200 border-solid flex flex-col sm:flex-row sm:h-96 ">
          <div className="imagecon w-full  sm:h-full sm:w-3/5 lg:w-2/5">
            <img src='https://images.unsplash.com/photo-1640763502425-7668dc1e4023?auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8bWljcm9zb2Z0fGVufDB8fDB8fHww&w=500' alt="" className="w-full h-full" />
          </div>
        ...
        <div className="main w-full  border-2 border-gray-200 border-solid flex flex-col sm:flex-row sm:h-96 ">
          <div className="imagecon w-full sm:h-full sm:w-3/5 lg:w-2/5">
            <img src='https://images.unsplash.com/photo-1633114128174-2f8aa49759b0?auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzB8fG1pY3Jvc29mdHxlbnwwfHwwfHx8MA%3D%3D&w=500' alt="" className="w-full h-full" />
          </div>
          <div className="description px-7 py-5 flex flex-col sm:justify-center md:justify-start items-start sm:w-2/5 lg:w-3/5 xl:justify-center">
      ...
      <div className="bigimage w-full flex justify-center mt-7 lg:h-96  xl:h-[35rem]">
        ...
        <div className="largeimg w-11/12  justify-start items-center hidden lg:flex h-full  bg-[url('https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/Highlight-Microsoft-Responsible-AI:VP4-1260x600')] bg-cover">
          <div className="innertext h-80 w-[29rem] ml-10 rounded  bg-white text-black border-solid   flex flex-col justify-center px-16">
            <h1 className=" font-semibold text-3xl ">Our blueprint for governing AI in India</h1>
            <p className=" mt-3 text-left">Microsoft is committed to developing and deploying AI in a safe, secure, and transparent way that can help expand positive outcomes in India—and the world.</p>
            <button className=' bg-blue-700 text-white  rounded w-80 text-center h-8 mt-5'>Learn about our approach to responsible AI</button>
          </div>
        </div>
      </div>
